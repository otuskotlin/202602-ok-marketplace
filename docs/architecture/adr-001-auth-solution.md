...
- [REQ-001: Регистрация и аутентификация](../business/requirements/REQ-001.md)
...
- OIDC: стандартные протоколы для интеграции с фронтендом и внешними системами
