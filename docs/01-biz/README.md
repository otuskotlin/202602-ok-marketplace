# Business Documentation — OK-Marketplace
...
### 2. Customers
- [CUSTOMER_PERSONAS.md](CUSTOMER_PERSONAS.md)
- [CJM.md](CJM.md)

### 3. Product (Business Requirements)
- [BR/](./BR/) — Business Requirements (BR-001.md — BR-010.md)
